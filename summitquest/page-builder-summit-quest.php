...
<head>
    ...
    <style>
        ...
        .bt-btn {
            ...
            background: inherit;
            /* preserve background from variant class */
            box-shadow: inherit;
            /* preserve shadow from variant class */
        }
        ...
        .bt-hero-left {
            ...
            /* <-- prevents forced vertical centering */
        }


        /* Right column containing the image + dashboard */
        .bt-hero-right {
            position: relative;
            padding-bottom: 0;
        ...
        /* Big panel that holds the image + overlay */
        ...
        .bt-hero-panel {
            ...
            border-radius: 28px;
            background:
                linear-gradient(145deg, rgba(15, 23, 42, 0.9), rgba(15, 23, 42, 0.86)),
        ...
        .bt-progress-fill {
            height: 100%;
            width: 0;
            background: linear-gradient(90deg, #22c55e, #22c55e 55%, #1d4ed8);
        ...
        .bt-card-soft {
            background: linear-gradient(145deg, #02091a, #071427);
        }
        ...
        .bt-dot {
            ...
            height: 6px;
            border-radius: 999px;
            background: var(--bt-accent-secondary);
            margin-right: 0.25rem;
        }



        /* ROUTE MAP (outer wrapper) */
        .bt-route-section {
            position: relative;
            ...
            width: 100%;
            max-width: none;
            /* let inner wrapper control width */
            margin-left: auto;
            margin-right: auto;
        }
        ...
        /* Mobile: stacked layout with clean spacing */
        .bt-route-premium-wrapper {
            ...
            box-sizing: border-box;
            max-width: 1600px;
            /* expanded canvas for desktop */
            margin-left: auto;
            margin-right: auto;
            margin-top: 4rem;
            /* move the whole section down from the title */
        }
        ...
        /* Desktop: wide grid, generous columns for cards and image */
        @media (min-width: 1024px) {
            .bt-route-premium-wrapper {
                display: grid;
                grid-template-columns:
                    minmax(400px, 1.5fr)
                    /* left cards: wider minimum */
                    minmax(700px, 2.2fr)
                    /* image: larger minimum */
                    minmax(400px, 1.5fr);
                /* right cards: wider minimum */
                gap: 4rem;
                padding-left: 2rem;
                padding-right: 2rem;
            }
        ...
        .bt-route-floating {
            ...
            gap: 1.4rem;
            margin-top: 0.5rem;
            /* slight nudge down to align with image */
        }
        ...
        /* Image wrapper: let grid spacing do the work */
        .bt-route-premium-image {
            box-sizing: border-box;
            padding: 0;
            display: flex;
            /* enables align stretch on desktop */
            align-items: stretch;
        }

        /* Image: taller, fills center column */
        ...
        @media (min-width: 1024px) {
            .bt-route-premium-image img {
                ...
                object-fit: cover;
                min-height: 680px;
                /* make the image longer; adjust to taste */
            }
        }


        /* ITINERARY / FEATURE PANEL */
        .bt-feature-row {
            display: grid;
            grid-template-columns: 1fr 1fr;
            gap: 2.5rem;
        ...
        .bt-feature-bar-fill {
            width: 70%;
            height: 100%;
            background: linear-gradient(90deg, #22c55e, #22c55e 60%, #1d4ed8);
        }
        ...
        /* Remove the faint divider */
        .bt-subtle-divider {
            display: none !important;
        }

        /* ============================================================
   MOBILE FIXES – ONLY UNDER 768px
============================================================ */
        ...
        @media (max-width: 480px) {
            ...
            @media (min-width: 640px) {
                .bt-button-row {
                    justify-content: flex-start;
                    /* or space-between depending on layout */
                }

                .bt-button {
                    width: auto;
                    /* stop full-width at tablet */
                    flex: 0 1 240px;
                    /* grow/shrink nicely */
                }
            }
                                ...
                                <div class="bt-hero-dash">
                                    <div class="bt-hero-dash-header">
                                        <div>
                                            ...
                                            <div class="bt-hero-dash-sub">Track your journey from arrival to summit
                                                simulation.</div>
                                        </div>
                                    ...
                                    <div class="bt-hero-dash-row" style="margin-top:0.75rem;">
                                        <div class="bt-text-muted" style="font-size:0.8rem;">
                                            Next departure: <span style="color:var(--bt-text-soft);">May 3 · Virtual Base
                                                Camp check-in</span>
                                        </div>
            ...
            <div class="bt-container">
                ...
                <div class="bt-grid-3">
                    ...
                    <div class="bt-card bt-card-soft">
                        ...
                        <div class="bt-card-thumb" style="background-image:url('http://learning-platform.local/wp-content/uploads/2025/11/builder-summit-dinner7.png');"></div>
                    </div>
        ...
        <section class="bt-section bt-route-section">
            ...
            <div class="bt-route-premium-wrapper">
                ...
                <div class="bt-route-premium-image">
                    <img src="http://learning-platform.local/wp-content/uploads/2025/11/builder-summit-second-map8.png"
            ...
            <div class="bt-container">
                <div class="bt-vr-grid">
                    ...
                    <div class="bt-vr-media">
                        <img src="http://learning-platform.local/wp-content/uploads/2025/11/builder-summit-vr-image6.png"
            ...
            <div class="bt-container">
                <div class="bt-pricing-row">
                    <div>
                        ...
                        <div class="bt-pricing-gear">
                            <img src="http://learning-platform.local/wp-content/uploads/2025/11/builder-summit-3fanned-1.png"
